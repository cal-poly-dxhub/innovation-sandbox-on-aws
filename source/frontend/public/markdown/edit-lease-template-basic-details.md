...
Update the template's name, description, visibility, and approval requirements.

---

**Visibility**:

- **Public**: Visible to all users for self-service requests
- **Private**: Only visible to Admins and Managers for direct assignment
