...
_Note: Sandbox requests with no approvals required and leases created through direct assignment are not displayed on this page. Auto-approved requests and assigned leases provide users with immediate access to their AWS accounts._
